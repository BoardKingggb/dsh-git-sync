 ...
 */
import { GitSync } from "./service.js";
import { resolveConfig } from "./config.js";
import { installGitSyncSettings } from "./settings.js";
export { Config } from "./config.js";
export { GitSync } from "./service.js";
export { GitSyncEngine } from "./engine.js";
...
function statusLine(status) {
    ...
    if (status.conflict)
        parts.push('conflict: kept local ⚠');
